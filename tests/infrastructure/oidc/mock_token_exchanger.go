...
//
//	mockgen -source=token_exchanger.go -destination=../../../tests/infrastructure/oidc/mock_token_exchanger.go -package=oidc
//
...
func (m *MockTokenExchanger) ExchangeCode(ctx context.Context, code string) (*oidc.OAuthToken, error) {
	m.ctrl.T.Helper()
