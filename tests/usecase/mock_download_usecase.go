...
func (m *MockDownloadUseCase) HandleDownloadObject(ctx context.Context, oid domain.OID, size domain.Size) usecase.ResponseObject {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HandleDownloadObject", ctx, oid, size)
	ret0, _ := ret[0].(usecase.ResponseObject)
	return ret0
}

// HandleDownloadObject indicates an expected call of HandleDownloadObject.
func (mr *MockDownloadUseCaseMockRecorder) HandleDownloadObject(ctx, oid, size any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleDownloadObject", reflect.TypeOf((*MockDownloadUseCase)(nil).HandleDownloadObject), ctx, oid, size)
}
