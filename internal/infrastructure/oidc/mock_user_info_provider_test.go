...
//
//	mockgen -source=user_info_provider.go -destination=mock_user_info_provider_test.go -package=oidc
//
...
func (m *MockUserInfoProvider) GetUserInfo(ctx context.Context, token *oauthToken) (*gitHubUser, error) {
	m.ctrl.T.Helper()
